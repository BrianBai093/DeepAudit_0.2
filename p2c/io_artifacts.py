...
REQUIRED_FILES = [
    ...
    "execution/env_repair/llm_repair_guidance.json",
    ...
    "execution/env_repair/pip_freeze.txt",
    "execution/env_repair/conda_list.txt",
    "execution/env_repair/sdk_repair_prompt.txt",
    "execution/env_repair/sdk_session_result.json",
    "execution/env_repair/sdk_session_stdout.log",
    "execution/env_repair/sdk_session_stderr.log",
    "execution/env_repair/sdk_session_narrative.log",
    "execution/code_compat/code_compat_result.json",
    "execution/code_compat/code_compat_patch.diff",
    "execution/code_compat/sdk_code_compat_prompt.txt",
    "execution/code_compat/sdk_session_result.json",
    "execution/code_compat/sdk_session_stdout.log",
    "execution/code_compat/sdk_session_stderr.log",
    "execution/code_compat/sdk_session_narrative.log",
...
class ArtifactManager:
    ...
    def _default_json_payload(rel: str) -> Any:
        ...
        _MAP: dict[str, Any] = {
            ...
            "phase2_execution_package.json": {"schema_version": "phase2_execution_package.v1",
            ...
            "reproduced_figures.json": {"figures": [], "reason_codes": [_P]},
            "reproducibility_score.json": {"total_score": 0, "dimensions": [], "ecr": False,
                                           "ecr_reason": "Pipeline not complete yet.",
                                           "gaps": [], "reason_codes": [_P]},
            ...
            "env_setup_result.json": {"env_name": "", "validation_passed": False,
                                      "reason_codes": [_P]},
            "env_repair_result.json": {"status": "skipped", "reason_codes": [_P]},
            "native_env_diagnosis.json": {"reason_codes": [_P]},
            "llm_repair_guidance.json": {"reason_codes": [_P]},
            "repaired_environment_spec.json": {"reason_codes": [_P]},
            "code_compat_result.json": {"status": "skipped", "reason_codes": [_P]},
